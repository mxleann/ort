...
val CROSSD_METRICS: Array<CrossdMetric> = arrayOf(
    CrossdMetric(
        ...
        descriptionShort = "This metric expresses the distribution of contributions by the community across the companies the contributors belong to.",
    ...
    CrossdMetric(
        ...
        descriptionShort = "Considered as quality metric, this measure includes a repositories age, issues and releases.",
    ...
    CrossdMetric(
        ...
        descriptionShort = "The support rate refers to issues and pulls which received a response during the last 90 days.",
    ...
    CrossdMetric(
        ...
        descriptionShort = "This percentage score represents the existence of several files such as the readme or the contributing file.",
        documentationUrl = "https://health.crossd.tech/doc#github-community-health-percentage-7",
        higherIsBetter = true,
        averageValue = 56.29,
        valueGetter = { it["github_community_health_percentage"]?.jsonObject["custom_health_score"]?.jsonPrimitive?.double }
    )
)
