...
[#assign advisorResults = helper.advisorResultsWithHealthMetrics()]
...
[#list helper.filterHealthMetrics(innerResult.healthMetrics) as health]
...
[#list helper.filterHealthMetrics(result.healthMetrics) as health]
